package com.enn.iot.dtu.common.util.json;
...
public class JsonUtils {
    ...
    public static <T> T readObject(String jsonString, TypeReference valueTypeRef) {
        ...
        T result;
        try {
            result = (T)OBJECT_MAPPER.readValue(jsonString, valueTypeRef);
        } catch (IOException e) {
    ...
    public static String readAsStringExcept(Object obj, String... properties) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        FilterProvider filters = new SimpleFilterProvider().addFilter("dynamicFilter",
