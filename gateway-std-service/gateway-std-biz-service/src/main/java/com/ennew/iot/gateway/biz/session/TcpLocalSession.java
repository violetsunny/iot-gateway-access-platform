...
@Slf4j
@Data
public class TcpLocalSession implements ServerSession {

    private static final Transport transport = DefaultTransport.TCP;

    /**
     * 绑定 Session 与 Channel 的 key
     */
//    public static final AttributeKey<TcpLocalSession> SESSION_KEY =
//            AttributeKey.valueOf("SESSION_KEY");
    ...
    public TcpLocalSession(Channel channel, String deviceId) {
        this.channel = channel;
        this.sessionId = sessionId(channel,deviceId);
        this.deviceId = deviceId;
    }

    public TcpLocalSession bind() {
